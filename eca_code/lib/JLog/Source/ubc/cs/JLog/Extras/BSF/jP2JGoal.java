...
public class jP2JGoal extends jGoal {
	...
	public jP2JGoal (jTerm t1, jTerm t2, JLogBSFEngine engineParam) {
		super();
		src = t1;
		dest = t2;
	...
	public boolean prove (iGoalStack goals, iGoalStack proved) {
		if (DEBUG) System.out.println("bsf_p2j/2::");

		Object obj = null;
		if ((src instanceof jVariable) && ((jVariable) src).isBound()) {
				jTerm term = ((jVariable) src).getTerm();
				obj = engine.term2object(term);
		} else
			throw new IllegalArgumentException("Variable 'Object' is unbound");

		if (dest.unify(new jObject(obj), unified)) {
			proved.push(this);
			return true;
		} else {
	...
	public String getName() { return "bsf_p2j"; }
