...
public class jStatic extends jBinaryBuiltinPredicate {

	protected JLogBSFEngine engine;

	public jStatic (jTerm lhs, jTerm rhs) {
 ...
 {
  goals.push(new jStaticGoal(lhs.duplicate(vars), rhs.duplicate(vars), engine));
 }; 

 public void 	addGoals(jGoal g,iGoalStack goals)
 {
  goals.push(new jStaticGoal(lhs, rhs, engine));
 }; 

 public jBinaryBuiltinPredicate 	duplicate(jTerm t1,jTerm t2)
 {
  return new jStatic(t1, t2); 
 };
};
