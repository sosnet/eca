...
public class jCreate3 extends jTrinaryBuiltinPredicate {

	protected JLogBSFEngine engine;

	public jCreate3 (jTerm t1, jTerm t2, jTerm t3) {
 ...
 {
  goals.push(new jCreateGoal(term1.duplicate(vars), term2.duplicate(vars), term3.duplicate(vars), engine));
 }; 

 public void addGoals (jGoal g,iGoalStack goals)
 {
  goals.push(new jCreateGoal(term1, term2, term3, engine));
 }; 

 public jTrinaryBuiltinPredicate duplicate(jTerm t1,jTerm t2,jTerm t3)
 {
  return new jCreate3(t1, t2, t3); 
 };
};
