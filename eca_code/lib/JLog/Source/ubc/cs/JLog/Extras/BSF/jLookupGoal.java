...
public class jLookupGoal extends jGoal {

	protected static final boolean DEBUG = false;

	protected jTerm name, result;
	protected jUnifiedVector unified;
	protected JLogBSFEngine engine;

	public jLookupGoal (jTerm t1, jTerm t2, JLogBSFEngine engineParam) {
		super();
		name = t1;
		result = t2;
		engine = engineParam;
	...
	public boolean prove (iGoalStack goals, iGoalStack proved) {
		...
		if (! (result instanceof jVariable))
			throw new IllegalArgumentException("Parameter 'Result' is not a variable");

		boolean success = false;

		Object obj = engine.lookupBean(nameStr);
		if (DEBUG) System.out.println("bsf_lookup/2::"+nameStr+"::"+obj);
		if (obj != null)
	...
	public String getName() { return "bsf_lookup"; }
