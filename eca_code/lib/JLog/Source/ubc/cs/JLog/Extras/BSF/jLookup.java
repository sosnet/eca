...
public class jLookup extends jBinaryBuiltinPredicate {

	protected JLogBSFEngine engine;

	public jLookup (jTerm lhs, jTerm rhs) {
 ...
 {
  goals.push(new jLookupGoal(lhs.duplicate(vars), rhs.duplicate(vars), engine));
 }; 

 public void 	addGoals(jGoal g,iGoalStack goals)
 {
  goals.push(new jLookupGoal(lhs, rhs, engine));
 }; 

 public jBinaryBuiltinPredicate 	duplicate(jTerm t1,jTerm t2)
 {
  return new jLookup(t1, t2); 
 };
};
