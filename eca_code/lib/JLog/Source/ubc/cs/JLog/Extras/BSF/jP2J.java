...
public class jP2J extends jBinaryBuiltinPredicate {

	protected JLogBSFEngine engine;

	public jP2J (jTerm lhs, jTerm rhs) {
 ...
 {
  goals.push(new jP2JGoal(lhs.duplicate(vars), rhs.duplicate(vars), engine));
 }; 

 public void 	addGoals(jGoal g,iGoalStack goals)
 {
  goals.push(new jP2JGoal(lhs, rhs, engine));
 }; 

 public jBinaryBuiltinPredicate 	duplicate(jTerm t1,jTerm t2)
 {
  return new jP2J(t1, t2); 
 };
};
