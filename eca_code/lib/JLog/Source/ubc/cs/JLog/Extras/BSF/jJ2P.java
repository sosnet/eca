...
public class jJ2P extends jBinaryBuiltinPredicate {

	protected JLogBSFEngine engine;

	public jJ2P (jTerm lhs, jTerm rhs) {
 ...
 {
  goals.push(new jJ2PGoal(lhs.duplicate(vars), rhs.duplicate(vars), engine));
 }; 

 public void 	addGoals(jGoal g,iGoalStack goals)
 {
  goals.push(new jJ2PGoal(lhs, rhs, engine));
 }; 

 public jBinaryBuiltinPredicate 	duplicate(jTerm t1,jTerm t2)
 {
  return new jJ2P(t1, t2); 
 };
};
